...
public class MeasureCache {
  ...
  public MeasureCache put(String componentKey, DefaultMeasure<?> measure) {
    Preconditions.checkNotNull(componentKey);
    Preconditions.checkNotNull(measure.metric());
    cache.put(componentKey, measure.metric().key(), measure);
    return this;
  }
